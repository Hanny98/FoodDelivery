<%-- 
    ...
    Created on : Jan 14, 2021, 9:38:12 PM
    Author     : User
--%>
...
<html>
    <head>
        ...
        <title>User Profile - Upload Profile Pic</title>
        ...
        <main role="main" class="container">
         ...
         <div class="jumbotron">
            <div class="container">
               ...
               <p>
                  User - Change Profile Picture <br> 
            ...
            <div class="col-md-6">
               ...
               <div class="card shadow">
                  <div class="card-body">     
                    ...
                    <form method="post" action="/FoodDelivery/UserUpdateProfilePicServlet" enctype="multipart/form-data" class="form-group">
