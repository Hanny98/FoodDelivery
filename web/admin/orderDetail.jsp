<%-- 
    ...
    Created on : Jan 16, 2021, 8:45:11 PM
    Author     : User
--%>
            ...
            <div class="col-md-12">
               ...
               <div class="card shadow">
                  <div class="card-body">
                      ...
                      <h2>Order Details</h2>
                      <h3>Order ID: <c:out value="${sessionScope.detailedOrder.orderID}"/></h3>
                           ...
                           <tbody>
                               <c:set var="totalPrice" value="${0}"/>
                                  <c:forEach items="${sessionScope.dishListOfDetailedOrder}" var="dish" varStatus="loop">
                                      <c:set var="dishTotalPrice" value="${dish.price * Integer.parseInt(sessionScope.quantityList[loop.index])}"/>
                                      ...
                                      <tr>
                                          ...
                                          <td><c:out value="${sessionScope.quantityList[loop.index]}"/></td>
