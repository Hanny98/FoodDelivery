<%-- 
    ...
    Created on : Jan 13, 2021, 7:34:50 PM
    Author     : User
--%>
...
<html>
    ...
    <body>
            ...
            <div class="col-md-6">
               ...
               <div class="card shadow">
                  <div class="card-body">     
                     ...
                     <img src="/FoodDelivery/img/<jsp:getProperty name="admin" property="photo"/>" width="100" height="100"/>
                     <br><br>
                     <button type="button" class="btn btn-primary" onclick="redirectToUploadPic()">Change Profile Picture</button>      
                     <br><br>
                     <p>
                         Full Name : <jsp:getProperty name="admin" property="fullname"/>
                         <br>
                         User Type: <jsp:getProperty name="admin" property="userType"/>
                     </p>  
                  </div>
               </div>
      ...
      <script> 
          ...
          {
              window.location = "/FoodDelivery/admin/uploadProfilePic.jsp";
          }
      </script>
