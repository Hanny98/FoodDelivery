<%-- 
    Document   : uploadDishPic
    Created on : Jan 14, 2021, 7:12:18 PM
    Author     : User
--%>
...
<html>
    <head>
        ...
        <title>Admin - Upload Dish Picture</title>
            ...
            <div class="col-md-6">
               ...
               <div class="card shadow">
                  <div class="card-body">     
                    ...
                    <h2>Upload new dish picture</h2>
                    <img src="/FoodDelivery/img/${param.originalPhoto}" width="50" height="50">
                    <form method="post" action="/FoodDelivery/UpdateDishPicServlet" enctype="multipart/form-data" class="form-group">
