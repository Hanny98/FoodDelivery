    ...
    <body>
                  ...
                  <div class="card-body">
                     ...
                     <div class="table-responsive"> 
                        <table class="table table-striped table-bordered table-hover">
                           ...
                           <tbody>
                               <c:forEach items="${sessionScope.orderList}" var="order" varStatus="loop">
                                   ...
                                   <tr>
                                        ...
                                        <td><c:out value="${sessionScope.recipientList.get(loop.index)}"/></td>
                         ...
                         <td><button type="button" class="btn btn-primary" onclick="redirectToRemoveDeliveredDish()">Hide Delivered Order</button></td>
                     </div> 
      ...
      <footer class="container">
         ...
         <p>&copy; Company 2017-2020</p>
                     ...
                     <script>
                         function redirectToRemoveDeliveredDish(){
                             window.location="/FoodDelivery/RemoveDeliveredOrderServlet";
