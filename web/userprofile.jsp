<%-- 
    ...
    Created on : Jan 14, 2021, 9:05:33 PM
    Author     : User
--%>
...
<html>
    ...
    <body>
                ...
                <ul class="navbar-nav"> 
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown07">
                      <a class="dropdown-item" href="#"><img src="icons/person.svg" alt="" width="20" height="20" title="Userprofile">&nbsp User Profile</a>
            ...
            <div class="col-md-6">
               ...
               <div class="card shadow">
                  <div class="card-body">     
                     ...
                     <img src="/FoodDelivery/img/<jsp:getProperty name="user" property="photo"/>" width="100" height="100"/>
                     <br><br>
                     <button type="button" class="btn btn-primary" onclick="redirectToUploadPic()">Change Profile Picture</button>      
                     <br><br>
                     <p>
                         Full Name : <jsp:getProperty name="user" property="fullname"/>
                         <br>
                         Address: <jsp:getProperty name="user" property="address"/>
                         <br>
                         User Type: <jsp:getProperty name="user" property="userType"/>
                     </p>

                     <button type="button" class="btn btn-primary" onclick="redirectToEditProfile()">Edit User Profile</button>
                  </div>
               </div>
      ...
      <script> 
          function redirectToUploadPic()
          {
              window.location = "/FoodDelivery/uploadProfilePic.jsp";
          }
          
          function redirectToEditProfile()
          {
              window.location = "/FoodDelivery/editUserProfile.jsp";
          }
      </script>
