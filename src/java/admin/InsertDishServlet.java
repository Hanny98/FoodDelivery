 ...
 * @author User
 */
@WebServlet(name = "InsertDishServlet", urlPatterns = {"/InsertDishServlet"})
public class InsertDishServlet extends HttpServlet {
    ...
    public void init() throws ServletException
    {
        ...
        jdbcUtility.prepareSQLStatementInsertDish();
    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            PreparedStatement ps = jdbcUtility.getPsInsertDish();
            
            ps.setString(1, dishCode);
            ps.setString(2, dishName);
            ps.setDouble(3, price);
            ps.setString(4, dishType);
            ps.setString(5, dishDescription);
