...
public class DecreaseQuantityServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            {
                if(quantityList.get(index).equals("1"))
                {
                    dishOrder.remove(index);
                    quantityList.remove(index);
                }
                else
                {
                    Integer newQuantity = Integer.parseInt(quantityList.get(index)) - 1;
                    
                    quantityList.set(index, newQuantity.toString());
                }
            }
