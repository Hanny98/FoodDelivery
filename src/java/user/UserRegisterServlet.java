    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       PrintWriter out = response.getWriter();
        ...
        try
        {
            ...
            //hash password
            String hashPassword = DigestUtils.sha512Hex(password + salt);
            ...
            {
                out.println("<script>");
                    out.println("alert('Register success, please login')");
                    out.println("window.location = '/FoodDelivery/index.html'");
                out.println("</script>");
            ...
            {
                out.println("<script>");
                    out.println("alert('Register fail, please retry')");
                    out.println("window.location = '/FoodDelivery/index.html'");
                out.println("</script>");
